...
if(!$nitCliente=="" && !$nameCliente=="" && !$apeCliente=="" && !$dirCliente=="" && !$phoneCliente=="" && !$emailCliente=="" && !$fullnameCliente==""){
    $verificar=  ejecutarSQL::consultar("select * from cliente where Nombre='".$nameCliente."'");
    ...
    if($verificaltotal<=0){
        ...
        echo '<img src="assets/img/error.png" class="center-all-contens"><br>El nombre de usuario ingresado ya esta registrado.<br>Por favor ingrese otro nombre de usuario';
    }
}else {
