    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel para agregar un producto nuevo <small class="tittles-pages-logo">TiendaFcc</small></h1>
            </div>
            <!-- Nav tabs -->
                        ...
                        <div class="panel panel-info">
                          ...
                          <div class="table-responsive">
                              <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      <?php
                                      $nusuario = $_SESSION['nombreUser'];
                                        $productos=  ejecutarSQL::consultar("select * from producto where Nombre = '$nusuario'");
                                        $upr=1;
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>ID</label>
                                    <input class="form-control" type="text" name="prove-nit" placeholder="ID proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                             ...
                             <div class="panel panel-info">
                              ...
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      ...
                                      <tbody>
                                          <?php
                                            $pedidoU=  ejecutarSQL::consultar("select * from venta where Vendedor = '$nusuario'");
                                            $upp=1;
