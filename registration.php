        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">TiendaFcc</small></h1>
                </div>
                ...
                <div class="col-xs-12 col-sm-6">
                   <br><br>
                    <div id="container-form">
                       <p style="color:#fff;" class="text-center lead">Rellene todos los campos para registrarse</p>
                       <br><br>
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su numero de whatsapp" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su numero de whatsapp." maxlength="10">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="tel" placeholder="Ingrese su número telefónico de domicilio" required name="clien-phone" maxlength="12" pattern="[0-9]{7,12}" data-toggle="tooltip" data-placement="top" title="Ingrese su número telefónico. Mínimo 7 digitos, máximo 12">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
